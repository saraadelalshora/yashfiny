    ...
    <nav class="navbar navbar-expand-lg d-none d-lg-block header-sticky">
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="col-md-6 navbar-nav mr-auto">
                ...
                <div class="col-md-2 main-logo">
                    <a href="<?= base_url()?>" class="headerLogo"><img src="<?=base_url('assets/images/logo.png')?>" alt=""></a>
                </div>

              <div class="col-md-1 language">
                <ul class="list-unstyled ">
                   <?php  if($setting->language=='arabic'){ ?>
                        <li><a href="<?= base_url('home/chane_language/english') ?>" id="userLang"><i class="fa fa-globe"></i> EN</a></li>
                    <?php }else{ ?>
                        <li><a href="<?= base_url('home/chane_language/arabic') ?>" id="userLang"><i class="fa fa-globe"></i> AR</a>
                   <?php } ?>
                </ul>
              </div>
