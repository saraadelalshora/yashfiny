        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="footer-des">
                    <img src="<?=base_url();?>assets/images/logoss.png" class="img-responsive footer-logo" alt="">
            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="col-block">
                            ...
                            <ul class="footer-link list-unstyled quickLink">
                              <li><a href="#<?//= base_url($menu->url)?>">اتصل بنا</a></li>
                              <li><a href="#<?//= base_url($menu->url)?>">من نحن </a></li>
                              <li><a href="#<?//= base_url($menu->url)?>">فريق يشفيني</a></li>
                              <li><a href="#<?//= base_url($menu->url)?>">انضم الينا كطبيب</a></li>
                              <li><a href="#<?//= base_url($menu->url)?>">انضم الينا كفريق</a></li>
                    ...
                    <div class="col-md-3">
                        <div class="col-block">
                            <h3 class="footer-title"><?= display('Legal_File')?></h3>
                            <ul class="footer-link list-unstyled">

                              <li><a href="#<?//= base_url('departments/details/'.$department->dprt_id)?>">حذف بياناتي </a></li>

                              <li><a href="#<?//= base_url('departments/details/'.$department->dprt_id)?>">شروط الإستخدام </a></li>

                              <li><a href="#<?//= base_url('departments/details/'.$department->dprt_id)?>">إتفاقية الخصوصية</a></li>

                              <li><a href="#<?//= base_url('departments/details/'.$department->dprt_id)?>">إتفاقية الخصوصية للأطباء</a></li>
                    ...
                    <div class="col-md-5">
                        <h3 class="footer-title"><?= display('Download_Our_Apps')?></h3>


                      <div class="addressLink">
                        <ul class="list-unstyled">
                          <li><a href="#"><img src="<?=base_url();?>assets/images/google-play.png"/></a></li>
                          <li><a href="#"><img src="<?=base_url();?>assets/images/apple-ios.png"/></a></li>
                        </ul>
                      </div>
                      ...
                      <div class="btnBlock ">
                        <ul class="list-unstyled">
                          ...
                          <li><a href="#"><img src="<?=base_url();?>assets/images/twitter.png"/></a></li>
                          <li><a href="#"><img src="<?=base_url();?>assets/images/youtube.png"/></a></li>
...
<!-- /.footer -->
<div class="sub-footer dark" style="display:none">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="coptText">
