    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-7">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="media contact-service">
                                ...
                                <div class="media-body">
                                    <h4 class="mt-0">تليفون<?//= display('address')?></h4>
                            ...
                            <div class="media contact-service">
                                ...
                                <div class="media-body">
                                    <h4>البريد الالكتروني<?//= display('working_hours')?></h4>
                                    <div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="media contact-service">
                                ...
                                <div class="media-body">
                                    <h4>+201069606061<?//= display('write_us')?></h4>
                                    <div>
                                        <?php
                            ...
                            <div class="media contact-service">
                                ...
                                <div class="media-body">
                                    <h4>ahmed.fci22@gmail.com<?//= display('call_us')?></h4>
                                    <div>
                                        <?php
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9">
                            ...
                            <div class="contact-header"><h4>  العنوان </h4></div>

                            <div class="media contact-service">
                                <i class="flaticon-world mr-3"></i>
                                <div class="media-body">
                                    <h4 class="mt-0">123 باب توبل ميدان فيكتوريا<br>الاسكندرية - جمهورية مصر العربية<?//= display('address')?></h4>
                                    <!-- <div><?= (!empty($setting->address)?$setting->address:null)?></div> -->
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="contact-header"><h4>قم بمتابعتنا علي: </h4></div>
                </div>
            ...
            <div class="col-md-12 col-lg-5">
              ...
              <div class="contact-us-title">
                <h2><?= display('lets_talk')?></h2>
              </div>


                <div class="contact-form">
                  <div class="contact-us-title">
                    <h4><?= display('Inquiries_and_Suggestions')?></h4>
                    <p class="desc">
                      <?= display('Inquiries_and_Suggestions_desc')?>
                    </p>
                  </div>
                    <!-- Message & exception -->
                    <div class="msg"> </div>
