<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            $_SESSION['username']="tamkeen_user";
            $_SESSION['password']="G-JT&b@XhZa}";
            $_SESSION['database']="tamkeen_yashfiny";
                        ...
                        <div class="page-content">
                            <div class="outer-container">
                                ...
                                <div class="col-md-12 fText">
                                    <div class="row">
                                        <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="#">Ahmed Abozeid</a></div>
